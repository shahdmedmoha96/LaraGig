...
''
            <form method="POSt" action="{{route('listing.updata',$listing->id)}} "enctype="multipart/form-data">
                ...
                <img class=" w-48 mr-6 md:block" src="{{ $listing->logo ? route('ListImage.show',$listing->logo) : asset('images/no-image.png')}}" alt="" />
                ...
                <div class="mb-6">
                    ...
                    <a href="{{route('listings.index')}}" class="text-black ml-4">
                        Back
                    </a>
                </div>
            </form>
